package com.gs.framework.security.filter;
...
public class JwtAuthenticationTokenFilter extends OncePerRequestFilter
{
    ...
    @Override
    protected void doFilterInternal(@NotNull HttpServletRequest request, @NotNull HttpServletResponse response, FilterChain chain)
