...
import com.gs.common.utils.poi.ExcelUtil;
...
import com.gs.framework.security.service.SysPermissionService;
...
public class SysRoleController extends BaseController
{
    ...
    public AjaxResult edit(@Validated @RequestBody SysRole role)
    {
        ...
        if (roleService.updateRole(role) > 0)
        {
            ...
            if (StringUtils.isNotNull(loginUser.getAdminUser()) && !loginUser.getAdminUser().isAdmin())
            {
                loginUser.setPermissions(permissionService.getMenuPermission(loginUser.getAdminUser()));
                loginUser.setAdminUser(userService.selectUserByUserName(loginUser.getAdminUser().getUserName()));
