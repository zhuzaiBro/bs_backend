...
insert into sys_post values(4, 'adminUser', '普通员工',  4, '0', 'admin', sysdate(), '', null, '');
...
-- 二级菜单
insert into sys_menu values('100',  '用户管理', '1',   '1', 'adminUser',       'system/adminUser/index',        '', 1, 0, 'C', '0', '0', 'system:adminUser:list',        'adminUser',          'admin', sysdate(), '', null, '用户管理菜单');
...
-- 用户管理按钮
insert into sys_menu values('1001', '用户查询', '100', '1',  '', '', '', 1, 0, 'F', '0', '0', 'system:adminUser:query',          '#', 'admin', sysdate(), '', null, '');
insert into sys_menu values('1002', '用户新增', '100', '2',  '', '', '', 1, 0, 'F', '0', '0', 'system:adminUser:add',            '#', 'admin', sysdate(), '', null, '');
insert into sys_menu values('1003', '用户修改', '100', '3',  '', '', '', 1, 0, 'F', '0', '0', 'system:adminUser:edit',           '#', 'admin', sysdate(), '', null, '');
insert into sys_menu values('1004', '用户删除', '100', '4',  '', '', '', 1, 0, 'F', '0', '0', 'system:adminUser:remove',         '#', 'admin', sysdate(), '', null, '');
insert into sys_menu values('1005', '用户导出', '100', '5',  '', '', '', 1, 0, 'F', '0', '0', 'system:adminUser:export',         '#', 'admin', sysdate(), '', null, '');
insert into sys_menu values('1006', '用户导入', '100', '6',  '', '', '', 1, 0, 'F', '0', '0', 'system:adminUser:import',         '#', 'admin', sysdate(), '', null, '');
insert into sys_menu values('1007', '重置密码', '100', '7',  '', '', '', 1, 0, 'F', '0', '0', 'system:adminUser:resetPwd',       '#', 'admin', sysdate(), '', null, '');
-- 角色管理按钮
...
insert into sys_config values(2, '用户管理-账号初始密码',         'sys.adminUser.initPassword',         '123456',        'Y', 'admin', sysdate(), '', null, '初始化密码 123456' );
...
create table sys_logininfor (
                                ...
                                msg            text(1234)   default null                comment '提示消息',
